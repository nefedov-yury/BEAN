...
// cs_25Mar23: mass_KK_fit (LH) MCGPJ with fit results of 22Mar23
//--------------------------------------------------------------------
void SetData25M(Data& dt) {
//--------------------------------------------------------------------
   double Xisr_min;
#include "Picts/cs_25Mar23_results.h"
...
// 17Mar23: mass_KK_fit (LH), initial parameters of MCGPJ
//--------------------------------------------------------------------
...
//--------------------------------------------------------------------
   double Xisr_min;
#include "Picts/cs_SB_25Mar23_results.h"
...
// 10Feb23: side-band subtraction: 1.01 < Mkk < 1.03 GeV  OLD MCGPJ
//--------------------------------------------------------------------
...
//--------------------------------------------------------------------
   ...
   // string pdf( "cmpr_cs_25M_17M.pdf" ); // <- PDF
   ...
   SetData25M(dt[0]); // new mass_KK_fit (LH)
   dt[0].version = "LH-fit of M_{KK} with interference";
   SetDataSB_25M(dt[1]); // new SB: 1.01 < Mkk < 1.03 GeV
   dt[1].version = "Side-band subtraction";
   double Rmax=40., Rmin=-10.;
   string pdf( "cmpr_cs_25Mar23_fit_vs_SB.pdf" ); // <- PDF
...
//--------------------------------------------------------------------
   ...
   string pdf( "cmpr_cs_sysch.pdf" ); // <- PDF
   ...
   // R - percent
   double Eprt[] { 3.097227, 3.096986, 3.097226, 3.08 };
...
//--------------------------------------------------------------------
   ...
   string pdf( "cmpr_cs_sysweta.pdf" ); // <- PDF
