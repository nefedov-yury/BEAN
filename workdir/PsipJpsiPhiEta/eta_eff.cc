...
//--------------------------------------------------------------------
   ...
   string pdf1;
   if (par->slct == 2 ) {
      pdf1 = "eta_getaeff_" + to_string(date) + ".pdf";
   } else {
      pdf1 = "gamma_getaeff_" + to_string(date) + ".pdf";
   }
   c1->Print( pdf1.c_str() );
   ...
   string pdf2;
   if (par->slct == 2 ) {
      pdf2 = "eta_getarat_" + to_string(date) + ".pdf";
   } else {
      pdf2 = "gamma_getarat_" + to_string(date) + ".pdf";
   }
   c2->Print( pdf2.c_str() );
}
...
//--------------------------------------------------------------------
   ...
   gPad->RedrawAxis();
   c2->Update();
   string pdf2 = "eta_phietarat_" + to_string(date) + ".pdf";
   c2->Print( pdf2.c_str() );
}
