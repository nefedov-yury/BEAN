...
//     (Tue Mar  9 21:13:35 2021 by ROOT version6.22/06)
//   from TTree a4c/after 4C kinematic fit
//   found on file: mckketa_kkmc_12.root
//////////////////////////////////////////////////////////


//Reset ROOT and connect tree file
   gROOT->Reset();
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mckketa_kkmc_12.root");
   if (!f) {
      f = new TFile("mckketa_kkmc_12.root");
   }
    TDirectory * dir = (TDirectory*)f->Get("mckketa_kkmc_12.root:/PsipJpsiPhiEta");
