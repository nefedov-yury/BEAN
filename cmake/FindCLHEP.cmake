...
#     MESSAGE( STATUS "+++ contents=\n${contents}\n+++" )
  ...
  MESSAGE( STATUS "Looking for CLHEP... CLHEP_FOUND= ${CLHEP_FOUND}" )
  ...
  IF( CMAKE_SYSTEM_NAME MATCHES Windows ) # WINDOWS
    ...
    # Set CLHEP_LIBRARIES
    SET( CLHEP_LIBRARIES "${CLHEP_LIBRARY_DIR}/CLHEP-${CLHEP_VERSION}.lib" )
  ...
  ELSE() # LINUX and MACOS
    ...
    IF( CLHEP_CONFIG_EXECUTABLE )
      EXEC_PROGRAM( ${CLHEP_CONFIG_EXECUTABLE} ARGS "--prefix" 
        OUTPUT_VARIABLE _prefix_dir )
    ...
    IF( is_credible )
      ...
      # Set CLHEP_VERSION
      EXEC_PROGRAM( ${CLHEP_CONFIG_EXECUTABLE} ARGS "--version" 
      ...
      EXEC_PROGRAM( ${CLHEP_CONFIG_EXECUTABLE} ARGS "--include"
        OUTPUT_VARIABLE CLHEP_INCLUDES )
      ...
      # Set CLHEP_LIBRARIES
      EXEC_PROGRAM( ${CLHEP_CONFIG_EXECUTABLE} ARGS "--libs"
    ...
    ELSE() # is not credible 
      ...
      # Set CLHEP_LIBRARIES
      SET( CLHEP_LIBRARIES "-L${CLHEP_LIBRARY_DIR} -lCLHEP-${CLHEP_VERSION}" )
