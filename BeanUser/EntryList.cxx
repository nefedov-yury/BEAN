...
// -- set global variable 'action' to ENL_FILL to save list of selected //
//    events in file 'FileName'                                         //
...
//-----------------------------------------------------------------------------
{
   ...
   selector->RegInDir( his2o     ,"EntryList");
   ...
   case ENL_READ: {
        ...
        enlst = (TEntryList*) file.Get(EntryListName); // rean Entry List
        if( !enlst ) {
